...
import {  fetchAllTrialBalance} from "api/accounting.api";
      ...
      {isFetching && <Loader />}
        ...
        <div className="flex flex-row gap-2 mt-2.5 p-5 bg-white	">
          <Grid container spacing={2}>
            <Grid item xs={6} className="mt-[22px]">
            <SearchComboBox options={glAccounts} placeholder="Begin G/L Account" />
            </Grid>
           
            <Grid item xs={6}>
            <Button variant="text" className="p-0 text-xs w-full justify-end">Add New</Button>
            <SearchComboBox options={period} placeholder="Begin Book Period" />
            </Grid>
            <Grid item xs={6} className="mt-[22px]">
              
            <SearchComboBox options={glAccounts} placeholder="End G/L Account" />
            </Grid>
            <Grid item xs={6}>
            <Button variant="text" className="p-0 text-xs w-full justify-end">Add New</Button>
            ...
            <Grid item xs={6}>
            <CheckBox {...{onChange: () => {setChecked(prev => !prev );}, checked, label:"All Accounts" }} />  
            </Grid>
